...
// como se construye el cliente de Supabase. Auth, Database y Storage se
...
// 2. Crear un proyecto en https://supabase.com
// 3. Crear un archivo `.env.local` en la raíz del proyecto con:
//      VITE_SUPABASE_URL=https://tu-proyecto.supabase.co
//      VITE_SUPABASE_ANON_KEY=tu-anon-key
// 4. Descomentar el bloque de abajo (y borrar el `export const supabase = null`)
// ============================================================================
...
// Bandera util para que el resto de la app (UI de login, guards, etc.)
// pueda distinguir "todavía no conectamos Supabase" de "hay un error real
// de autenticación", y mostrar un mensaje apropiado en cada caso.
